    ...
    * */
    ...
    public Password(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            * 而是px的话，程序会直接抛出异常。
            * */
            passwordLength = ta.getInteger(R.styleable.MyEditText_passwordLength,6);

            passwordColor = ta.getColor(R.styleable.MyEditText_passwordColor,0xf00);
            passwordWidth = ta.getDimensionPixelSize(R.styleable.MyEditText_passwordWidth,12);//px
            passwordRadius = ta.getDimensionPixelSize(R.styleable.MyEditText_passwordRadius,6);

            borderColor = ta.getColor(R.styleable.MyEditText_borderColor,0x000000);
            borderWidth = ta.getDimensionPixelSize(R.styleable.MyEditText_borderWidth,8);//px
            borderRadius = ta.getDimensionPixelSize(R.styleable.MyEditText_borderColor,6);
