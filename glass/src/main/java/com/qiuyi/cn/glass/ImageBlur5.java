 ...
 *
 */
public class ImageBlur5 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blur5);
    ...
    private void initData(){
        ...
        Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.newtimg2);
        // Pixels JNI NativeBitmap
        Bitmap newBitmap = StackBlur.blurNativelyPixels(bmp, (int) 30, false);//毛玻璃效果
